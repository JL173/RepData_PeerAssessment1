...
The time at which the maximum number of steps occurs is at 08:35 with `r max(interval_mean$mean)`
...
The data as missing `r number_of_NA` values, which is 8 days. (2304 / 288) 
